...
from senteval.sts import STS12Eval, STS13Eval, STS14Eval, STS15Eval, STS16Eval, STS162Eval, STSCZEval, STSCZ2Eval, STSCZsmallEval, STSBenchmarkEval
...
class SE(object):
    def __init__(self, params, batcher, prepare=None):
        ...
        self.list_tasks = ['CR', 'MR', 'MPQA', 'SUBJ', 'SST2', 'SST5', 'TREC', 'MRPC',
                           ...
                           'STS14', 'STS15', 'STS16', 'STS162', 'STSCZ', 'STSCZ2', 'STSCZsmall',
    ...
    def eval(self, name):
        ...
        elif name in ['STS12', 'STS13', 'STS14', 'STS15', 'STS16', 'STS162']:
            fpath = name + '-en-test'
            self.evaluation = eval(name + 'Eval')(tpath + '/downstream/STS/' + fpath, seed=self.params.seed)
        elif name in ['STSCZ', 'STSCZ2', 'STSCZsmall']:
            fpath = name + '-cz-test'
            self.evaluation = eval(name + 'Eval')(tpath + '/downstream/STS/' + fpath, seed=self.params.seed)
